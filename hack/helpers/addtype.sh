...
gofmt -s -w \
	...
	"apis/${group_lower}/${APIVERSION}/doc.go" \
	"apis/${group_lower}/${APIVERSION}/groupversion_info.go" \
	"internal/controller/${kind_lower}/${kind_lower}.go" \
	"internal/controller/${kind_lower}/${kind_lower}_test.go"
