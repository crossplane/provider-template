...
func (mg *MyType) GetDeletionPolicy() runtimev1alpha1.DeletionPolicy {
	return mg.Spec.DeletionPolicy
}

// GetProviderConfigReference of this MyType.
func (mg *MyType) GetProviderConfigReference() *runtimev1alpha1.Reference {
...
*/
func (mg *MyType) GetProviderReference() *runtimev1alpha1.Reference {
...
func (mg *MyType) SetDeletionPolicy(r runtimev1alpha1.DeletionPolicy) {
	mg.Spec.DeletionPolicy = r
}

// SetProviderConfigReference of this MyType.
func (mg *MyType) SetProviderConfigReference(r *runtimev1alpha1.Reference) {
...
*/
func (mg *MyType) SetProviderReference(r *runtimev1alpha1.Reference) {
